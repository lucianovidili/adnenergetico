...
let animalsArray = [
    "Rata", "Buey", "Perro", "Liebre", "Dragón", "Serpiente", "Caballo", "Cabra", "Mono", "Gallo", "Tigre", "Cerdo"
];
...
function populateImages() {
    ...
    let nPictures;
    const imgHeightBig = 222;
    const imgWidthBig = 234;
    ...
    if (screen.width <= maxWidthSmartphone) {
        ...
        imgHeight = imgHeightBig;
        imgWidth = imgWidthBig;
        nPictures = 12;
    }
